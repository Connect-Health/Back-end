...
public class Controller {
        ...
        private List<Profissional> profissionais = List.of(
                        new Profissional(1, "João", "Silva", "11999999999", "1999-01-01", "11111111111", "Rua 1",
                                        "joao@gmail",
                                        "https://avatars.githubusercontent.com/u/125279572?s=96&v=4",
                                        List.of("Familia", "Depressao", "Ansiedade", "Constipação", "Diarréia",
                                                        "Disbiose", "Dislipidemia",
                                                        "Enxaqueca",
                                                        "Fibromialgia", "Insônia", "Menopausa", "TPM", "Infertilidade",
                                                        "Gestação", "Lactação",
                                                        "Crianças", "Adolescentes"),
                                        "https://conhecimento.sti.ufpb.br/uploads/images/gallery/2022-08/scaled-1680-/1Mnt48ERQnwewxg2-image-1661441161358.png",
                                        "1h", "R$ 100,00",
                                        "Olá! Meu nome é João Silva e sou um nutricionista recém-formado pela Universidade de São Paulo. Durante minha formação, pude perceber a importância da nutrição para a saúde das pessoas e como uma alimentação adequada pode fazer toda a diferença na qualidade de vida. Meu objetivo como nutricionista é ajudar meus pacientes a alcançarem seus objetivos de saúde e bem-estar, através de uma abordagem individualizada e baseada em evidências científicas. Acredito que uma alimentação saudável pode ser prazerosa e acessível a todos, e estou animado para colocar em prática meus conhecimentos e contribuir para a melhoria da qualidade de vida das pessoas.",
                                        "Nutrição", "5"),
                        new Profissional(2, "Maria", "Souza", "11988888888", "1990-05-21", "22222222222", "Rua 2",
                                        "maria@gmail",
                                        "https://avatars.githubusercontent.com/u/125279606?s=96&v=4",
                                        List.of("Depressao", "Estresse", "Autoestima",
                                                        "Ansiedade", "Relacionamento", "Familia", "Luto", "Sexualidade",
                                                        "Transtorno Alimentar",
                                                        "Vícios", "Orientação Profissional", "Orientação Vocacional",
                        ...
                        new Profissional(3, "Pedro", "Rodrigues", "11977777777", "1985-12-10", "33333333333", "Rua 3",
                                        ...
                                        List.of("Obesidade", "Diabetes", "Hipertensão",
                                                        ...
                                                        "Gastrite", "Refluxo",
                                                        "Síndrome do Intestino Irritável", "Anemia", "Colesterol Alto",
                                                        "Gota", "Osteoporose",
                                                        "Câncer", "Alergias"),
                                        "https://conhecimento.sti.ufpb.br/uploads/images/gallery/2022-08/scaled-1680-/1Mnt48ERQnwewxg2-image-1661441161358.png",
                                        "1h30min", "R$ 120,00",
                        ...
                        new Profissional(4, "Camila", "Almeida", "11999999999", "1990-03-10", "22222222222", "Rua 2",
                                        ...
                                        List.of("Depressão", "Ansiedade", "Estresse", "Fobias",
                        ...
                        new Profissional(5, "Gabriela", "Santos", "11999999999", "1995-05-20", "33333333333", "Rua 3",
                                        ...
                                        List.of("Emagrecimento", "Ganho de Massa Muscular", "Reeducação Alimentar",
                                                        "Doenças Metabólicas",
                        ...
                        new Profissional(7, "Mariana", "Lima", "11999999999", "1988-08-15", "55555555555", "Rua 5",
                                        ...
                                        List.of("Gestantes", "Puérperas", "Crianças", "Adolescentes",
                                                        "Obesidade Infantil",
